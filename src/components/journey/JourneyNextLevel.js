      ...
      <div className='relative pt-12 pb-6 px-4 sm:pt-10 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:grid lg:grid-cols-2'>
        <div className='lg:col-start-2 lg:pl-8'>
          <div className='text-base max-w-prose mx-auto lg:max-w-lg lg:ml-auto lg:mr-0 space-y-4'>
            ...
            <div className='mt-8 text-lg text-daviesGrey font-nunito'>
              {CONTENT.nextLevel}
              <footer className='mt-2 w-max'>
                <p className='flex flex-col font-medium text-sm'>
                  <a
                    ...
                    className='hover:text-glaucous text-richBlack'
                  >
                    Visit NEXT LEVEL
                  </a>
                </p>
        ...
        <div className='hidden lg:grid col-start-1 justify-items-end'>
          <blockquote className='hidden lg:block w-1/2 bg-yNBlue bg-opacity-50 font-poppins font-bold rounded-l-md text-right text-richBlack px-3 text-sm'>Looking out the &ldquo;Door of No Return&rdquo; on Goree Island, Senegal</blockquote>
        </div>
      </div>
    </div>
  )
