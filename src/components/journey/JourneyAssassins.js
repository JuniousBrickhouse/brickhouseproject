...
export default function Assassins () {
  return (
    <div className='relative bg-spanishGrey pt-16 pb-20 px-4 sm:px-6 lg:pt-14 lg:pb-28 lg:px-8'>
      {/* first three images */}
      <div className='hidden max-w-lg mx-auto lg:grid gap-5 lg:grid-cols-3 lg:max-w-none'>
      ...
      <div className='relative max-w-7xl mx-auto pt-14'>
        ...
        <div className='hidden max-w-lg mx-auto lg:grid gap-10 lg:grid-cols-2 lg:max-w-none'>
