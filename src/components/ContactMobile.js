...
export default function ContactMobile ({ triggerPageChangeAnimation }) {
  ...
  return (
    <>
      {/* Contact information */}
      <div className='relative overflow-hidden h-96 py-10 px-6 bg-23Raw bg-cover bg-center flex sm:hidden'>
      ...
      <div className='py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12'>
        ...
        <form onSubmit={handleSubmit} className='mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8'>
          ...
          <div className='sm:col-span-2 sm:flex sm:justify-end space-y-4 sm:space-y-0 sm:space-x-4'>
            <button
              type='submit'
